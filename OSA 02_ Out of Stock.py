...
# MAGIC %md 
# MAGIC
# MAGIC The purpose of this notebook is to identify inventory-related problems in the data including *phantom inventory*, *safety stock* alerts and *zero scan* alerts. This notebook has been developed by [Tredence](https://www.tredence.com/) in partnership with Databricks using a Databricks 8.2 cluster.
...
inventory = spark.table('osa.inventory')
vendor = spark.table('osa.vendor')
...
(
  all_alerts
    ...
    .write
      ...
      .saveAsTable('osa.inventory_flagged')
   )
